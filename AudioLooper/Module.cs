...
namespace AudioLooper
{
    class Module
    {
        ...
        public static string ApplicationName = "Audio Looper";
        ...
        public static string DownloadURL = "https://softpcapps.com/d/AudioLooper/";
        public static string HelpURL = "https://softpcapps.com/audio-looper/how-to-use.php";
        public static string ProductWebpageURL = "https://softpcapps.com/audio-looper/";
        public static string BuyURL = "https://softpcapps.com/store/buy-audio-looper.php";
        public static string VersionURL = "http://cssspritestool.com/versions/audio-looper.txt";

        public static string TipText = TranslateHelper.Translate("Great application to loop audio to make audio clip !");        
