                ...
                */
                ...
                if (numloop != 0)
                {
                    ...
                    if (true)
                    {
                        for (int k = 0; k < numloop; k++)
                        {
                            sa += "[" + k.ToString() + ":a:0]"+(fa==string.Empty?"acopy":fa)+"[a"+k.ToString()+"];";
                        }
                        ...
                        */
                        ...
                        {
                            sa += "concat=n=" + (numloop).ToString() + ":v=0:a=1[a]\" -map \"[a]\" -y " +
                ...
                if (ffmpegArgs.audioNormalize)
                {
                    ...
                    ffmpegArgs.NormalizeArgs2 = " -y -i \"" + ffmpegArgs.NormalizeFile + "\" -filter_complex \"[0:a:0]"+((fa!=string.Empty)?fa:"acopy")+",volume=" + "[REPLACE_MAXVOL]" + "dB[a1];"+
                        "[a1]concat=n=1:v=0:a=1[v][a]\" -map \"[a]\" "+ffmpegArgs.outputparams + metadata_args +" -y ";
