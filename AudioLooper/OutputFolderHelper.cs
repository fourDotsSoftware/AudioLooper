...
namespace AudioLooper
{
    class OutputFolderHelper
    {
        ...
        {
            if (folder == TranslateHelper.Translate("Subfolder of Audio")
                || folder == TranslateHelper.Translate("Overwrite Audio")
                || folder == TranslateHelper.Translate("Same Folder of Audio")
        ...
        {            
            ...
            if (outputfolder.Trim() == TranslateHelper.Translate("Same Folder of Audio"))
            {
