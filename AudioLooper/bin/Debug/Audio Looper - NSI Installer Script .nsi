...
;copy translations end
  ...
  !define MUI_FILE "AudioLooper"
  !define MUI_VERSION ""
  !define MUI_PRODUCT "Audio Looper"
  !define PRODUCT_SHORTCUT "Audio Looper"
  !define PRODUCT_VERSION "1.3"
  
  !define MUI_ICON "audio-looper-48.ico"
...
;  !define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\readme.txt"
  ...
  Name "Audio Looper"
  OutFile "AudioLooperSetup.exe"

  InstallDir "$PROGRAMFILES\softpcapps Software\${PRODUCT_SHORTCUT}"

  InstallDirRegKey HKLM "Software\softpcapps Software\Audio Looper" ""
...
;create start-menu items
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_SHORTCUT}\Audio Looper - User's Manual.lnk" "$INSTDIR\Audio Looper - User's Manual.url" "" "$INSTDIR\Audio Looper - User's Manual.url" 0
...
!endif
  ...
  ;!insertmacro InstallLib REGDLL $ALREADY_INSTALLED NOREBOOT_NOTPROTECTED .\FreeAudioLooperShellExtx64.dll $SYSDIR\FreeAudioLooperShellExt.dll $SYSDIR
  SetRegView 64
...
;   ExecWait '"$INSTDIR\vcredist_x86.exe" /q'
  ;!insertmacro InstallLib REGDLL $ALREADY_INSTALLED NOREBOOT_NOTPROTECTED .\FreeAudioLooperShellExt_vs2008_w7_x86.dll $SYSDIR\FreeAudioLooperShellExt.dll $SYSDIR
...
;!  inetc::get /SILENT "http://softpcapps.com/installmonetizer/FreeAudioLooper.php" "$PLUGINSDIR\Installmanager.exe" /end
...
;  ExecWait "$PLUGINSDIR\Installmanager.exe 015" 
 ...
 Call IsDotNetInstalledAdv
  ...
  File "Audio Looper - User's Manual.url";
...
;begin new uninstall strings
 ...
 ;Store installation folder
  WriteRegStr HKLM "Software\softpcapps Software\Audio Looper" "" $INSTDIR
  WriteRegStr HKLM "Software\softpcapps Software\Audio Looper" "InstallationDirectory" $INSTDIR
...
;  !insertmacro UnInstallLib REGDLL NOTSHARED NOREBOOT_NOTPROTECTED $SYSDIR\FreeAudioLooperShellExt.dll
  SetRegView 64
   SetShellVarContext all
; 64bit things here
...
;Delete Uninstaller And Unistall Registry Entries
  ...
  DeleteRegKey HKLM "Software\softpcapps Software\Audio Looper"
  DeleteRegKey HKCU "Software\softpcapps Software\Audio Looper"
...
Function .onInstSuccess
 ...
 ExecShell "" "http://softpcapps.com/audio-looper/how-to-use.php?afterinstall=true&version=${PRODUCT_VERSION}";
